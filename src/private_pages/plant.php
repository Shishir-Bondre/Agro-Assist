      ...
      <div class="row">
        <!-- =======Sidebar Slider Start========= -->
          ...
          <li ><a href="soil.php">Soil</a></li>
            <li class="active"><a href="javascript:void(0);">Plant</a></li>
        ...
        <div class="divider" style="opacity: .3"></div>
          ...
          <?php
          	$sql_qq = "select * from plant_photos";
          	$result2 = $con->query($sql_qq);
		if($result2->num_rows>0){
		  echo '<div class="row"><br>';
		     while($row2=$result2->fetch_assoc()){
		             echo '<div class="col s6 m6">';
		             echo '<img src="../images/'.$row2["photo_name"].'" class="materialboxed" width="60%" style="border-radius:5%;">';
		             echo '</div>';		     
		     }
		  echo '</div>';
		echo '<div class="divider" style="opacity:.3;"></div>';
		}          
          ...
          <div class="row" id="DynamicData">
              <?php plantInitialData($con,$RecordDate);?>
          </div>
        <div class="divider" style="opacity: .3"></div>
      </div>
      <!-- ==========Page content END========= -->    
...
*/
      $('select').material_select(function(e){
            ...
            $.ajax({
              url:"../includes/PlantResponsedData.php",
              method:"POST",
