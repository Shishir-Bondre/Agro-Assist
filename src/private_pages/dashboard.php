        ...
        <div class="divider"></div>
          ...
          <div class="row">
            ...
            <div class="col s6 m4 l4">
              <div>
                <img  src="../assets/img/t3.png" width="50%" >
                <h5 class="">Temperature</h5>
                <a href="javascript:void(0);" 
                  class="<?php echo getClassColorCode($tempHumidity[1]); ?> btn">
                    <?php echo $dht22_row['temperature']. " &#8451;";?>
                </a>
              </div>
            </div>
            <div class="col s6 m4 l4">
              <div>
                <img  src="../assets/img/h.png" width="51%">
            ...
            <div class="col s8 offset-s3 m4 l4">
              <div>
                <img  src="../assets/img/m.png" width="50%">
                <h5 class="">Moisture</h5>
                <a href="javascript:void(0);" class="<?php echo getClassColorCode($moisture);?> btn">
          ...
          <div class="row">
            <div class="col s12 m12 l12" style="background-color: #272D4E;">
              <p class="flow-text center" style="color:white;">Last Survey</p>
              <table class="bordered stripped highlight grey lighten-2">
                <tbody>
                  <tr>
                    <td>1</td>
                    <td><b>Soil Condition</b></td>
                    <td><a href="soil.php" class="btn green">Normal</a></td>
                  </tr>
                  <tr>
                    <td>2</td>
                    <td><b>Plant Condition</b></td>
                    <td><a href="plant.php" class="btn green">Normal</a></td>
                  </tr>
                </tbody>
              </table>
              <br>
